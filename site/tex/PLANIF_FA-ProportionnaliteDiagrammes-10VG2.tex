...
\multirow{6}{=}{Résoudre des problèmes de proportionnalité (propriétés, facteur de proportionnalité) :	
\begin{itemize}[label=$\triangleright$]
    \item Quantité/quantité (prix, masses, devises, \ldots)
    \item Agrandissement et réduction de figures
    \item Pente et é	chelle
    \item Pourcentage
\end{itemize}}
...
\node[box] (b2) at (y2) {%
\textbf{\large Échelle et pente}\\[4pt]
{\small\begin{tabularx}{10cm}{cXp{3cm}p{1cm}}
